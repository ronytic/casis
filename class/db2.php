...
class db{
	...
	private function sql($consulta,$a=0)
	{
	...
	function statusTable(){
	 ...
	 function getRecords ($where_str=false, $order_str=false,$group_str=false, $count=false, $start=0, $order_strDesc=false,$a=0)
	{
