	...
	if(count($al)==0){
		...
		if($asis['Can']>=1){
			...
			if($asi['Activo']==1){
				...
				$Mensaje="<h2>Salida Registrada</h2><br><span>".$al['Paterno']." ".$al['Materno']." ".$al['Nombres']."</span> RU:<span>".$al['Ru']."</span> Ci:<span>".$al['Ci']."</span> Hora: <span>".$hora."</span>";
				...
				$Mensaje="<h2>Retorno Registrada</h2><br><span>".$al['Paterno']." ".$al['Materno']." ".$al['Nombres']."</span> RU:<span>".$al['Ru']."</span> Ci:<span>".$al['Ci']."</span> Hora: <span>".$hora."</span>";
