...
class PDF extends FPDF{
		function Header(){
			...
			$this->Image("../images/certificado2014.jpg",0,0,280,216);//Horizontal
	...
	foreach($alumnos->mostrarTODOS() as $al){
	...
	//{
		...
		//Apellidos
		$pdf->SetXY(50,108);
		$pdf->Cell(200,12,utf8_decode(ucwords(mb_strtolower($al['Paterno']." ".$al['Materno']." ".$al['Nombres'],"utf8"))),0,0,"C",$relleno);
		//Nombres
		//$pdf->SetXY(110,75);
